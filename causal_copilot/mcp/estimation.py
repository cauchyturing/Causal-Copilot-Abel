...
def estimate_drl(
    ...
    *,
    ...
    # Guard: ensure T0/T1 exist in actual treatment values after discretization.
    # Matches inference.py:929-937 which resets T0/T1 to valid extremes.
    treatment_values = sorted(np.unique(T))
